...
const SARCASTIC_ERRORS = [
  'BRO COME AND FIX ME', 'I HAVE A PROBLEM', 'UH OH, SPAGHETTI OHS', 'HELP I HAVE FALLEN AND I CANT GET UP',
  ...
  'I REFUSE TO RUN THIS GARBAGE', 'OUCH. THAT HURT.', 'A MONKEY COULD CODE BETTER',
  'YIKES, WHO WROTE THIS?', 'HOUSTON, WE HAVE A PROBLEM', 'MAYDAY! MAYDAY!',
  'CODE RED! IM DYING HERE', 'SOMEONE CALL A DOCTOR', 'SAD BEEP BOOP NOISES'
];
